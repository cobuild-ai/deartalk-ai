...
| :--- | :---: | :---: | :---: | :--- |
| 🤖 **DearTalk Android IME** | `v1.0.5` | **Android 15 (API 35)** | **상용 안정화 버전 (Production Stable)** | 1-Tap 대화 파트너 언어 선택 UX, 지능형 양방향 자동 반전(Auto-Swap), 스크립트 일치 TTS 엔진, Voice Studio & 실시간 대면 통역기, LiteRT GPU |
