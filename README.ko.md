...
| :--- | :---: | :---: | :---: | :--- |
| 🤖 **DearTalk Android IME** | `v1.0.3` | **Android 15 (API 35)** | **문맥 기반 물음표/문장 부호 자동 완성 및 다국어 STT (Stable)** | Jetpack Compose Slate UI, 다국어 STT, 문맥 문장 부호, 6종 어조, LiteRT GPU 가속, PAD 표준 |
...
- **Play Asset Delivery (PAD) 표준:** 인앱 다운로더 없이 Google Play 공식 표준 배포 모델 연동.
