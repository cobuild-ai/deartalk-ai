...
**DearTalkAI** is architected from day one as a zero-network, local-only Android communication assistant. 
...
2. **Local Model Execution:** All inference operations are executed strictly on the device's CPU/GPU/NPU via Google LiteRT.
