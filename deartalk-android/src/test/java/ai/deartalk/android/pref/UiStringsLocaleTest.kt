...
class UiStringsLocaleTest {
    ...
    fun testLocaleOverride() {
        ...
        assertEquals("🎙️ DearTalk Live", UiStrings.dearTalkLiveTitle)
        ...
        assertEquals("🌟 On-Device AI", UiStrings.tierBadgeHigh)
        assertEquals("🟢 Local AI", UiStrings.tierBadgeBase)
        ...
        assertEquals("🌟 온디바이스 AI", UiStrings.tierBadgeHigh)
        assertEquals("🟢 로컬 AI", UiStrings.tierBadgeBase)
        ...
        // 3. 인도네시아어 오버라이드 테스트
        UiStrings.setLocale(Locale.forLanguageTag("id-ID"))
        assertEquals("Rapikan", UiStrings.toneRefine)
        assertEquals("Sopan", UiStrings.tonePolite)
        assertEquals("Kirim", UiStrings.apply)
        assertEquals("Batal", UiStrings.cancel)
        assertEquals("🎙️ DearTalk Live", UiStrings.dearTalkLiveTitle)
        assertEquals("✨ Gaya Bicara", UiStrings.modeToneTransform)
        assertEquals("🌐 Penerjemah", UiStrings.modeLiveTranslation)
        assertEquals("👩 Wanita", UiStrings.voiceFemale)
        assertEquals("👨 Pria", UiStrings.voiceMale)
        assertEquals("Yang Anda Katakan (STT)", UiStrings.rawSttTitle)
        assertEquals("✨ Hasil AI & Terjemahan", UiStrings.aiResultTitle)
        assertEquals("🌟 AI On-Device", UiStrings.tierBadgeHigh)
        assertEquals("🟢 AI Lokal", UiStrings.tierBadgeBase)
